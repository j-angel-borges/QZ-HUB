...
const renderers = {
  ...
  backlog: () => {
    ...
    document.getElementById('page-title').textContent = 'Tablero Backlog — QUARZ';
        ...
        <div class="backlog-selector-container">
          <a href="#backlog/personal" class="selector-card">
            <div class="selector-card-icon">
              <img src="/assets/quarz/QUARZ_3D_Cuarzo_Vertical_QZ-removebg-preview.png" alt="QUARZ" style="height: 64px; object-fit: contain;" />
            </div>
            <span class="selector-card-title">Espacio Personal</span>
            <span class="selector-card-desc">Cabina de productividad QUARZ: timeblocking, asistente IA y sincronización con Google Calendar.</span>
            <button class="btn-selector-enter">Entrar al Espacio</button>
          </a>
          <a href="#backlog/zentry" class="selector-card">
            <div class="selector-card-icon">
              <img src="/assets/quarz/QUARZ_3D_Corona_Simbolo.png" alt="ZentryOS" style="height: 64px; object-fit: contain;" />
            </div>
  ...
  herramientas: () => {
    ...
    container.innerHTML = `
      <div class="markdown-body">
        ...
        <!-- ========================================== -->
        <div style="background: rgba(255, 255, 255, 0.85); border: 1px solid #c2be9f; border-radius: 2px; padding: 24px; margin-bottom: 35px; box-shadow: 0 4px 20px rgba(194, 190, 159, 0.15);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; flex-wrap: wrap; gap: 10px;">
            <div style="display: flex; align-items: center; gap: 12px;">
              ...
              <div>
                ...
                <span style="font-size: 12px; color: var(--qz-text-muted); font-family: 'Space Mono', monospace;">Sin dependencias de APIs externas, cuotas ni pagos • Respuestas instantáneas basadas en el Plan Maestro</span>
              </div>
            </div>
          </div>

          <!-- Clean Chat Container (Completely Blank on Start) -->
          <div id="ai-chat-box" style="min-height: 280px; max-height: 450px; overflow-y: auto; background: #ffffff; border-radius: 2px; padding: 16px; margin-bottom: 16px; display: flex; flex-direction: column; gap: 12px; border: 1px solid rgba(194, 190, 159, 0.4);">
            <!-- Blank container: Starts completely clean -->
          </div>

          <!-- Chat Input Form -->
          <form id="ai-chat-form" style="display: flex; gap: 10px;">
            <input type="text" id="ai-chat-input" placeholder="Escribe tu consulta sobre el plan, rutinas, llamadas, ayuno o métricas..." style="flex: 1; padding: 12px 16px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-size: 14px; outline: none;">
            <button type="submit" class="btn btn-primary" style="padding: 12px 24px; font-weight: bold; border-radius: 2px; background: #111111; color: #ffffff; border: 1px solid #c2be9f; font-family: 'Space Mono', monospace;">Enviar ⚡</button>
          </form>
        </div>
        ...
        <div style="background: rgba(255, 255, 255, 0.85); border: 1px solid #c2be9f; border-radius: 2px; padding: 24px; margin-bottom: 35px; box-shadow: 0 4px 20px rgba(194, 190, 159, 0.15);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; flex-wrap: wrap; gap: 10px;">
            <div style="display: flex; align-items: center; gap: 12px;">
              ...
              <div>
                ...
                <span style="font-size: 12px; color: var(--qz-text-muted); font-family: 'Space Mono', monospace;">Registra tus reflexiones al cierre del día para alimentarlo en <code>03_JOURNAL_BITACORA</code></span>
              </div>
            </div>
            <input type="date" id="journal-date" value="${todayStr}" style="padding: 8px 12px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-size: 13px; font-family: 'Space Mono', monospace;">
          </div>
          ...
          <div style="margin-bottom: 16px;">
            ...
            <textarea id="journal-q1" rows="2" style="width: 100%; padding: 10px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.4); background: #ffffff; color: #111111; font-size: 13px;" placeholder="Ej. Realicé 25 llamadas de Royal Prestige, agendé 2 demos en San Borja..."></textarea>
          </div>
          ...
          <div style="margin-bottom: 16px;">
            ...
            <textarea id="journal-q2" rows="2" style="width: 100%; padding: 10px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.4); background: #ffffff; color: #111111; font-size: 13px;" placeholder="Ej. Bajón de energía a las 3pm, apliqué suspiro fisiológico e ingería chicharrón..."></textarea>
          </div>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <textarea id="journal-q3" rows="2" style="width: 100%; padding: 10px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.4); background: #ffffff; color: #111111; font-size: 13px;" placeholder="Ej. Finalizar el módulo Compose Device Owner Mode y prospectar en Limatambo..."></textarea>
          </div>

          <div style="display: flex; gap: 12px; justify-content: flex-end; flex-wrap: wrap;">
            <button id="journal-download-btn" class="btn btn-secondary" style="padding: 10px 18px; border-radius: 2px; font-weight: 600; border: 1px solid #c2be9f; font-family: 'Space Mono', monospace;">📥 Descargar .md para 03_JOURNAL_BITACORA</button>
            <button id="journal-save-btn" class="btn btn-primary" style="padding: 10px 24px; border-radius: 2px; font-weight: 600; background: #111111; color: #ffffff; border: 1px solid #c2be9f; font-family: 'Space Mono', monospace;">💾 Guardar Entrada del Día</button>
          </div>
        ...
        <div style="background: rgba(255, 255, 255, 0.85); border: 1px solid #c2be9f; border-radius: 2px; padding: 24px; margin-bottom: 35px; box-shadow: 0 4px 20px rgba(194, 190, 159, 0.15);">
          <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 20px;">
            ...
            <div>
              ...
              <span style="font-size: 12px; color: var(--qz-text-muted); font-family: 'Space Mono', monospace;">Simulación gráfica en tiempo real según los ratios de conversión de Royal Prestige y QUARZ</span>
            </div>
          </div>

          <!-- Progress Bar Global -->
          <div style="margin-bottom: 30px; background: #ffffff; padding: 18px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.4);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
              <span style="font-weight: bold; font-size: 14px; color: #111111; font-family: 'Space Grotesk', sans-serif;">🎯 Meta de Caja al 31 de Agosto (21 Días Restantes)</span>
            ...
            <div class="progress-bar-container" style="height: 16px; background: #f4f3ed; border-radius: 2px; overflow: hidden; border: 1px solid rgba(194,190,159,0.3);">
              <div id="funnel-progress-bar" class="progress-bar" style="width: 19.25%; background: linear-gradient(90deg, #111111 0%, #c2be9f 100%); height: 100%; border-radius: 0;"></div>
            </div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin-bottom: 30px;">
            <div style="background: #ffffff; border: 1px solid rgba(194, 190, 159, 0.4); border-radius: 2px; padding: 20px;">
              <h3 style="margin-top: 0; color: #111111; font-size: 1.1rem; display: flex; align-items: center; gap: 8px; font-family: 'Space Grotesk', sans-serif; text-transform: uppercase;">
              ...
              <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 16px;">
                <div>
                  ...
                  <input type="number" id="fn-rp-calls" value="40" min="0" style="width: 100%; padding: 8px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-weight: bold; font-family: 'Space Mono', monospace;">
                </div>
                <div>
                  <label style="font-size: 12px; color: var(--qz-text-muted);">Demos de Referidos Realizadas:</label>
                  <input type="number" id="fn-rp-ref-demos" value="3" min="0" style="width: 100%; padding: 8px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-weight: bold; font-family: 'Space Mono', monospace;">
                </div>
              </div>

              <div style="background: #f8f9fa; padding: 12px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.3); font-size: 12px; line-height: 1.6; font-family: 'Space Mono', monospace;">
                ...
                <div>• Referidos Generados (5-10 x demo): <strong id="fn-rp-new-refs" style="color: #a8a380;">37 referidos</strong></div>
            ...
            <div style="background: #ffffff; border: 1px solid rgba(194, 190, 159, 0.4); border-radius: 2px; padding: 20px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 16px;">
                <div>
                  ...
                  <input type="number" id="fn-zentry-prospects" value="15" min="0" style="width: 100%; padding: 8px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-weight: bold; font-family: 'Space Mono', monospace;">
                </div>
                <div>
                  <label style="font-size: 12px; color: var(--qz-text-muted);">Demos Realizadas (Tab A7 / iPad):</label>
                  <input type="number" id="fn-zentry-demos" value="5" min="0" style="width: 100%; padding: 8px; border-radius: 2px; border: 1px solid #c2be9f; background: #ffffff; color: #111111; font-weight: bold; font-family: 'Space Mono', monospace;">
                </div>
              </div>
              ...
              <div style="background: #f8f9fa; padding: 12px; border-radius: 2px; border: 1px solid rgba(194, 190, 159, 0.3); font-size: 12px; line-height: 1.6; font-family: 'Space Mono', monospace;">
                ...
                <div>• Capital Caja Empresa QUARZ (40%): <strong id="fn-zentry-company-gain" style="color: #a8a380;">S/ 1,271.19</strong></div>
                <hr style="border: 0; border-top: 1px solid #c2be9f; margin: 8px 0;">
        ...
        <div class="ia-cards-grid" style="grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); margin-bottom: 40px;">
          ${dispositivosData.map(d => `
            <div class="ia-card" style="border-left: 4px solid #c2be9f; background: #ffffff; border-radius: 2px; border-top: 1px solid rgba(194, 190, 159, 0.3); border-right: 1px solid rgba(194, 190, 159, 0.3); border-bottom: 1px solid rgba(194, 190, 159, 0.3);">
              <div class="ia-card-header" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span class="tag ${d.statusColor}" style="border-radius: 2px; font-family: 'Space Mono', monospace;">${d.status}</span>
              </div>
              <p style="font-size: 12px; color: var(--qz-text-muted); margin: 6px 0 10px 0;"><strong>Tipo:</strong> ${d.type} • <strong>SIM/Línea:</strong> ${d.sim}</p>
    ...
    function appendChatMessage(sender, text) {
      ...
      if (sender === 'user') {
        msgDiv.style.cssText = 'background: #f8f9fa; border-right: 3px solid #111111; border: 1px solid rgba(194,190,159,0.3); padding: 12px; border-radius: 2px; font-size: 13px; line-height: 1.5; align-self: flex-end; max-width: 85%; color: #111111;';
        msgDiv.innerHTML = `<strong>👤 Tú:</strong> ${text}`;
      } else {
        msgDiv.style.cssText = 'background: #ffffff; border-left: 3px solid #c2be9f; border: 1px solid rgba(194,190,159,0.4); padding: 12px; border-radius: 2px; font-size: 13px; line-height: 1.5; max-width: 85%; color: #111111;';
  ...
  doc: (docPath) => {
    ...
    // Set custom page icon/banner according to active module
    const isZentryDoc = state.activeDocPath && (state.activeDocPath.includes('zentry') || state.activeDocPath.includes('01-vision') || state.activeDocPath.includes('02-arquitectura') || state.activeDocPath.includes('03-marketing'));
    if (isZentryDoc) {
